				...
				<div class="block block__client">
					...
					<div class="client__row row">
						...
						<div class="col-md-4">
							...
							<?php if ($line["or_us"]) { ?>
								<div class="row">
									<div class="client__row-title col-4">
										Особовий рахунок:
									</div>
									<div class="client__row-data col-8">
										<?= $line["or_us"] ?>
									</div>
								</div>
							<?php } ?>
					...
					?>
						...
						<div class="client__row row">
							<div class="col-md-12">
								...
								?>
									<div class="row">
										<div class="client__history-col col-md-1"><?php echo date("d.m.y", $his_row["date"]); ?></div>
										<div class="client__history-col client__history-col--type col-md-2"><?= $type ?></div>
										<div class="client__history-col col-md-3"><?php echo $his_row['client'] . '<br>' . $his_row['adress']; ?></div>
										<div class="client__history-col client__history-col--linedata col-md-4">
											<?php
										...
										<div class="client__history-col col-md-2"><?= $his_row['user'] ?></div>
									</div>
